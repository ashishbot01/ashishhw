...
🌷 KALAU MAU RENAME TARO CREDITS GUA : ashish☆ */
...
browser: ['ASHISH BOTZ','Safari','1.0.0'],
auth: state})
//=================================================//
...
haikal.send5ButImg(pea[0].id, `「 Perhatian !!!! 」\n\nGroup has been closed by admin, Now only admin can send message !`, `Group Settings Has Been Changed By Admin`, wm_fatih, [])
} else if(pea[0].announce == false) {
haikal.send5ButImg(pea[0].id, `「 Perhatian !!!! 」\n\nThe group has been opened by the admin, Now participants can send messages !`, `Group Settings Have Been Changed By Admin`, wm_fatih, [])
} else if (pea[0].restrict == true) {
haikal.send5ButImg(pea[0].id, `「 Perhatian !!!! 」\n\nGroup info has been restricted, Now only admin can edit group info !`, `Group Settings Have Been Changed By Admin`, wm_fatih, [])
} else if (pea[0].restrict == false) {
haikal.send5ButImg(pea[0].id, `「 Perhatian !!!! 」\n\nGroup info has been opened, Now participants can edit group info !`, `Group Settings Have Been Changed By Admin`, wm_fatih, [])
} else {
haikal.send5ButImg(pea[0].id, `「 Perhatian !!!! 」\n\nGroup Subject has been changed to *${pea[0].subject}*`, `Group Settings Have Been Changed By Admin`, wm_fatih, [])}})
//=================================================//
...
let fgclink = {key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "919122814903@whatsapp.net"}, "message": {orderMessage: {itemCount: 9999999,status: 200, thumbnail: buffer, surface: 200, message: `${metadata.subject}`, orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
he = `HELLO 👋 WELCOME TO THE GROUP ${metadata.subject} @${num.split("@")[0]}\n\n${metadata.desc}`
let link = `https://chat.whatsapp.com/Jh0EznQhxbkCHIre0L2bTr`
let buttons = [
{buttonId: `ashish☆`, buttonText: {displayText: buttonvirus}, type: 1},
]
let buttonMessage = {
...
mentions: [num],
fileName: `HELLO 👋 WELCOME TO THE GROUP ${metadata.subject}`,
...
title: `Do not forget to smile ☺️`,
body: `SUBSCRIBE ASHISH BOTZ☆`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
mediaUrl: link,}}}
...
contextInfo:{externalAdReply:{
title: `Do not forget to smile ☺️`,
body: `JOIN MY GROUP ashish maker☆`,
mediaType:2,
thumbnail: buffer,
sourceUrl: link,
mediaUrl: link,}}}
